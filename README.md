...
### Prerequisites
Select a text box.  
Script takes the following input:
An integer number (between 1 and 30) then comma(,) followed by column gap value (with valid units).  
If a unit is not added for column gap value, it takes the default measurement value.

### Notes
This sample ships with QuarkXPress 2018.  

### Screenshots  
![QuarkXPress document](http://www.quarkforums.com/resources/git/md_images/columnsandgutter1.png)  
